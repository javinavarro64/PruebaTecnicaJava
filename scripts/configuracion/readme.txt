...
amb la propietat de sistema "es.intricom.pruebaconcepto.properties".
...
a dins l'apartat de <system-properties>:
    ...
    ...
    <system-properties>
        <property name="es.intricom.pruebaconcepto.properties" value="/ruta/cap/al/fitxer/pruebaconcepto.properties"/>
    </system-properties>
    ...
